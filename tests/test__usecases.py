...
def test_start_conversation():
    ...
    mock_db.save_chat.assert_called_once()  # Se asegura de que se haya guardado el chat
...
def test_continue_conversation_no_chat_found():
    ...
    mock_db.get_chat.return_value = None  # Asegúrate de que esto sea None
...
# Nuevas pruebas para los puertos
...
class TestAgentPort:
    ...
    def test_agent_call(self):
        ...
        # Simula el comportamiento del método __call__ del mock
