...
def test_should_continue_conversation_with_input(chat_service, mock_chat_repository, mock_chat_agent):
    ...
    user_query = "¿Cuál es tu jugador favorito?"
    ...
    mock_chat_agent.get_last_response.return_value = "El bicho siuu"
